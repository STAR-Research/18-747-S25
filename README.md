# CMU ECE 18-747: Data Center Computing (Spring 2025)
...
### Schedule
Please submit a review for each paper on [hotcrp](https://cmu-18-747-s25.hotcrp.com/) by 9 am ET on the day of the class. Here is the review [template](https://gist.github.com/kasikci/49e7107dfdee281d6f6450b132555550) we will use.
...
| Jan 27 (M) | [An Open-Source Benchmark Suite for Microservices and Their Hardware-Software Implications for Cloud and Edge Systems](http://www.csl.cornell.edu/~delimitrou/papers/2019.asplos.microservices.pdf) | Web application paradigms | -[Supplemental reading](https://www.nginx.com/blog/introduction-to-microservices/) | Chen Li | Siqi Cao | Pragna Mamidipaka |
| Jan 29 (W) | [Profiling a Warehouse-Scale Computer](https://static.googleusercontent.com/media/research.google.com/en//pubs/archive/44271.pdf) | Microarchitecture analysis |  - Submit project proposal document describing project topic (<=1 page) </br> | Ranjeeth Sekhar | Deepanjali Mishra | Shreesh Tripathi |
| Feb 03 (M) | [SoftSKU: Optimizing Server Architectures for Microservice Diversity @Scale](https://dl.acm.org/doi/10.1145/3307650.3322227) | Microarchitecture analysis | -[Supplemental reading](http://csl.stanford.edu/~christos/publications/2018.search.hpca.pdf) | Chen Li | Pragna Mamidipaka | Sean Hyacinthe | Lola Okesanjo |
| Feb 05 (W) | [A Reconfigurable Fabric for Accelerating Large-Scale Datacenter Services](http://dl.acm.org/citation.cfm?id=2665678)| Hardware acceleration |  - [Supplemental reading](https://www.csl.cornell.edu/~delimitrou/papers/2021.asplos.dagger.pdf) <br/>  - Submit project deliverables document (<=1 page) </br> | Shreesh Tripathi | Ranjeeth Sekhar  | Lola Okesanjo |
| Feb 10 (M) | [A hardware accelerator for protocol buffers](https://sagark.org/assets/pubs/protoacc-micro2021-preprint.pdf) | Hardware acceleration | - [Supplemental reading 1](https://www.gwern.net/docs/cs/2021-ranganathan.pdf) </br> [Supplemental reading 2](https://michaeltaylor.org/papers/ASIC_Cloud_ISCA_2016_Proceedings.pdf) | Vignesh Natarajan | Sean Hyacinthe | Deepanjali Mishra |
| Feb 12 (W) | [AsmDB: Understanding and Mitigating Front-End Stalls in Warehouse-Scale Computers](https://dl.acm.org/doi/pdf/10.1145/3307650.3322234) | Compiler/PGO |   - [Supplemental reading](https://dl.acm.org/doi/pdf/10.1145/3466752.3480124) | Rahul Prabhu | Sidharth Babu | Jaehyun Lim |
| Feb 17 (M) | -[The Tail at Scale](https://cacm.acm.org/magazines/2013/2/160173-the-tail-at-scale/fulltext) </br> -[Attack of the Killer Microseconds](https://abelay.github.io/6828seminar/papers/barroso:killermicroseconds.pdf)| Tail latency, Killer microseconds | [Supplemental reading](https://docs.wixstatic.com/ugd/66fd54_b1a7b4d81fee4750a8cfd19107c8f55a.pdf) | Josiah Miggiani (Tail) </br> Eesha Karnawat (Microseconds) | Aditi Narasimhan (Tail) </br> Rahul Prabhu (Microseconds)| Andrew Gao (Tail) </br> Ranjeeth Sekhar  (Microseconds)| 
| Feb 19 (W) | [Dynamo: facebook's data center-wide power management system](https://ieeexplore.ieee.org/document/7551415)| Power/energy |  | Sean Hyacinthe | Omolola Okesanjo (Lola) | Daiyaan Arfeen |
| Feb 24 (M) | [Resource Central: Understanding and Predicting Workloads for Improved Resource Management in Large Cloud Platforms](https://www.microsoft.com/en-us/research/wp-content/uploads/2017/10/Resource-Central-SOSP17.pdf) | Resource management/scheduling |  </br> - [Supplemental reading](http://research.google.com/pubs/pub43438.html) </br> - First project milestone due on Feb 25 (<=5 pages) |  Sidharth Babu | Daiyaan Arfeen | Jaehyun Lim |
| Feb 26 (W) | [Serverless in the Wild: Characterizing and Optimizing the Serverless Workload at a Large Cloud Provider](https://www.microsoft.com/en-us/research/uploads/prod/2020/05/serverless-ATC20.pdf) | Serverless computing |   - [Supplemental reading](https://www.cs.utexas.edu/users/witchel/pubs/jia21asplos-nightcore.pdf) |  Pragna Mamidipaka | Deepanjali Mishra | Sidharth Babu  |
| Mar 03 (M) | **Spring break: No Class** |  | | 
| Mar 05 (M) | **Spring break: No Class** |  | |
| Mar 10 (M) | [Cost-Efﬁcient Overclocking in Immersion-Cooled Datacenters](https://www.microsoft.com/en-us/research/publication/cost-ef%ef%ac%81cient-overclocking-in-immersion-cooled-datacenters/) | DC cooling | |  Daiyaan Arfeen | Josiah Miggiani | Vignesh Natarajan |
| Mar 12 (W) | [Chasing Carbon: The Elusive Environmental Footprint of Computing](https://arxiv.org/pdf/2011.02839.pdf) | Sustainability |  | Shreesh Tripathi | Eesha Karnawat | Aditi Narasimhan  |
| Mar 17 (M) | [Designing Cloud Servers for Lower Carbon](https://www.microsoft.com/en-us/research/publication/designing-cloud-servers-for-lower-carbon/) | Sustainability | - Guest: [Udit Gupta](https://ugupta.com/) </br> - [Supplemental reading](https://hotcarbon.org/2023/pdf/a7-lyu.pdf) </br> |  Omolola Okesanjo (Lola) | Jaehyun Lim | Josiah Miggiani  |
| Mar 19 (W) | - [Nines are not enough](https://research.google/pubs/nines-are-not-enough-meaningful-metrics-for-clouds/) | DC business model | | Aditi Narasimhan | Andrew Gao | Rahul Prabhu  |
| Mar 24 (M) | No paper review | Ethics |  |  | |  |
| Mar 26 (W) | [Software-defined far memory in warehouse-scale computers](https://www.cs.purdue.edu/homes/csjgwang/CloudNativeDB/WSCMemoryASPLOS19.pdf) | ML for datacenter systems | - [Supplemental reading](https://www.microsoft.com/en-us/research/uploads/prod/2020/01/CACM20-produced.pdf) |  Andrew Gao | Sidharth Babu | Chen Li |
| Mar 31 (M) | [Cores that don't count](https://research.google/pubs/cores-that-dont-count/) | Reliability | - Second project milestone due on Apr 1 (<=7 pages) | Jaehyun Lim | Vignesh Natarajan | Eesha Karnawat |
